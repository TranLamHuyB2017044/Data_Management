<template>
    <div>
        <div
            class="sidebar container-fluid d-flex flex-column justify-content-center align-items-center">
            ...
            <div
                ...
                <div class="col" v-for="film in films" :key="film.movie_id">
...
export default {
    ...
    async mounted() {
        await this.filmStore.getAllFilms();
        this.films = this.filmStore.films;
    },
};
</script>
<style scoped>
